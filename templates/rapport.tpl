...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active text-primary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            Rapports
                        </a>
    ...
    <div class="container">
        ...
        <div class="row mb-3">
            <h4 class="text-primary"> {$auteur}, {$date_rapport} </h4>
            <h4 class="text-secondary"> Intervention : </h4>
            <h4 class="text-secondary">{$type}, {$lieu}, {$date_inter}</h4>
        </div>
